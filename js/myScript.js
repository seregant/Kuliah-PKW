...
function regValidation() {
	...
	var tanggal = document.forms["registrasi"]["tanggal-lahir"].value;
    ...
    if (nama == "") {
        ...
        document.forms["registrasi"]["alamat"].focus();
        return false;
    } else if (tanggal == "") {
        alert("Tanggal lahir harus diisi");
        document.forms["registrasi"]["tanggal-lahir"].focus();
        return false;
    } else if (mail == "") {
        ...
        document.forms["registrasi"]["password"].focus();
        return false;
    } else if (password2 == "") {
